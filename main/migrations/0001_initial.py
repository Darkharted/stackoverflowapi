    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('athor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='replies', to=settings.AUTH_USER_MODEL)),
                ('proble', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.problem')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proble', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pictures', to='main.problem')),
            ],
            options={
                'abstract': False,
            },
